...
- updating material mkdocs image to latest to get fixes and docker multi-arch support
...
- ENHANCEMENT | BBL-528 added alt default branch and logic to find out whether main or master is the default branch ([#34](https://github.com/binbashar/le-dev-makefiles/issues/34))
...
- Merge branch 'master' of github.com:binbashar/le-dev-makefiles
- Fix for material-mkdocs circleci job GH deploy error unsafe repository ('/docs' is owned by someone else)
...
- removing deprecated flags for cytopia/terraform-docs:0.16.0


<a name="v0.1.38"></a>
## [v0.1.38] - 2021-11-17

- Adding terraform 1.0.9 and terratest 1.0.9 makefiles
...
- Merge branch 'master' of github.com:binbashar/le-dev-makefiles
- adding terraform 1.0.9 version for ref arch tests
...
[v0.1.38]: https://github.com/binbashar/le-dev-makefiles/compare/v0.1.37...v0.1.38
[v0.1.37]: https://github.com/binbashar/le-dev-makefiles/compare/v0.1.36...v0.1.37
